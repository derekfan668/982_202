...
#define TCFG_DEBUG_USED_UARTX               1   //0=使用UART0打印, 1=使用UART1打印
...
#define TCFG_EXTERN_NTC_ENABLE              ENABLE_THIS_MOUDLE //外置NTC
...
#define TCFG_EAR_CHARGE_FULL_CURRENT_MA     5//耳机充电判满电流 
