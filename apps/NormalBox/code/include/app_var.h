...
//收到几次满电后判定耳机满电
#define TCFG_EAR_FULL_DET_CNT	 20 // <32 
//自动关机计数
...
typedef struct {
	...
	u8 force_charge: 1;		//强制充电--普通充电舱不使用
	u8 det_flt: 4;			//负载检测延时
...
#define b_discharge_ear_offline_hw  discharge_sw.u.b6  //左右耳都物理离线	
